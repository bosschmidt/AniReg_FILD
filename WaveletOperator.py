...
class WaveletOperator(LinearOperator):
    ...
    def direct(self, x, out = None, weight = None):
        ...
        coeffs = pywt.wavedecn(x_arr, wavelet=self.wname, level=self.level, axes=self.axes, mode='periodic')
    ...
    def adjoint(self, Wx, out = None, weight = None):
        ...
        x = pywt.waverecn(coeffs, wavelet=self.wname, axes=self.axes, mode='periodic')
